<div class="sidebar" id="sidebar">
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                <li class="active">
                    <a href="index.html"><img src="{{ URL::to('admin/assets/img/icons/dashboard.svg') }}"
                            alt="img"><span> Dashboard</span> </a>
                </li>
                <li class="submenu">
                    <a href="javascript:void(0);"><img
                            src="{{ URL::to('admin/assets/img/icons/product.svg') }}" alt="img"><span>
                ...
                <li class="submenu">
                    <a href="javascript:void(0);"><img
                            src="{{ URL::to('admin/assets/img/icons/sales1.svg') }}" alt="img"><span>
                ...
                <li class="submenu">
                    <a href="javascript:void(0);"><img
                            src="{{ URL::to('admin/assets/img/icons/purchase1.svg') }}" alt="img"><span>
                ...
                <li class="submenu">
                    <a href="javascript:void(0);"><img
                            src="{{ URL::to('admin/assets/img/icons/expense1.svg') }}" alt="img"><span>
                ...
                <li class="submenu">
                    <a href="javascript:void(0);"><img
                            src="{{ URL::to('admin/assets/img/icons/quotation1.svg') }}"
                ...
                <li class="submenu">
                    <a href="javascript:void(0);"><img
                            src="{{ URL::to('admin/assets/img/icons/transfer1.svg') }}" alt="img"><span>
                ...
                <li class="submenu">
                    <a href="javascript:void(0);"><img
                            src="{{ URL::to('admin/assets/img/icons/return1.svg') }}" alt="img"><span>
                ...
                <li class="submenu">
                    <a href="javascript:void(0);"><img
                            src="{{ URL::to('admin/assets/img/icons/users1.svg') }}" alt="img"><span>
                ...
                <li class="submenu">
                    <a href="javascript:void(0);"><img
                            src="{{ URL::to('admin/assets/img/icons/places.svg') }}" alt="img"><span>
                ...
                <li class="submenu">
                    <a href="javascript:void(0);"><img src="{{ URL::to('admin/assets/img/icons/time.svg') }}"
                ...
                <li class="submenu">
                    ...
                    <ul>
                        ...
                        <li><a href="{{URL::to('userlist')}}">Users List</a></li>
                    </ul>
                </li>
                <li class="submenu">
                    <a href="javascript:void(0);"><img
                            src="{{ URL::to('admin/assets/img/icons/settings.svg') }}" alt="img"><span>
